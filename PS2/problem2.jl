# Problem 2 – Simulated Method of Moments (SMM), Karol Kotuła, Olaf Jarosz 
...
function smm_objective(θ::Vector{Float64},
    ...
    # Initializing sums of simulated moments
    sim_m1 = 0.0
    sim_m2 = 0.0
    sim_m3 = 0.0
...
# 5. Minimizing Q(θ) using Optim.jl
